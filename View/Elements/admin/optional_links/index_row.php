...
<tr<?php echo $class; ?>>
	...
	<td style="width: 45px;">
		<?php echo $bcBaser->link($data['OptionalLink']['id'], array('action' => 'edit', $data['OptionalLink']['id']), array('title' => '編集')) ?>
	</td>
	<td>
	...
	<td>
		<?php echo $bcText->booleanDo($data['OptionalLink']['blank'], '指定') ?>
	</td>
	<td style="white-space: nowrap">
		<?php echo $bcTime->format('Y-m-d', $data['OptionalLink']['created']) ?>
		<br />
		<?php echo $bcTime->format('Y-m-d', $data['OptionalLink']['modified']) ?>
	</td>
</tr>
